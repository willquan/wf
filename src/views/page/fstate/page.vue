...
export default {
    ...
    data() {
        return {
            add: {name:'AddTab', label: '添加状态', closable: true, show: false},
            edit: {name:'EditTab', label: '编辑状态', closable: true, show: false},
            view: {name:'ViewTab', label: '查看信息', closable: true, show: false},
            tabs: [
                {name:'ListTab', label: '状态列表', closable: false, show: true}, 
            ]
        }
    }
}
